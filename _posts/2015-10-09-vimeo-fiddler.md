...
{% lightbox images/posts/create_app.png --data="vimeo_fiddler_image_set" --title="Create a new app" --alt="Create a new app"  --img_style="max-width:80%;" %}
...
{% lightbox images/posts/fiddler_reference.png --data="vimeo_fiddler_image_set" --title="adding Fiddler.exe as a resource" --alt="adding Fiddler.exe as a resource" --img_style="max-width:80%;" %}

Edit `AssemblyInfo.cs` and add reference to Fiddler as shown in the image.

{% lightbox images/posts/assembly.png --data="vimeo_fiddler_image_set" --title="Assembly.cs" --title="Assembly.cs" --alt="Assembly.cs"  --img_style="max-width:80%;" %}
...
{% lightbox images/posts/decrypt.png --data="vimeo_fiddler_image_set" --title="decrypt HTTPS" -alt="decrypt HTTPS" --img_style="max-width:80%;" %}

 **It will ask you to add a root certificate generated by Fiddler.**
<br>

{% lightbox images/posts/trust.png --data="vimeo_fiddler_image_set" --title="trust Fiddler?" --alt="trust Fiddler?" --img_style="max-width:80%;" %}
